...
log_info "バックアップディレクトリ設定中..."

BACKUP_DIR="/var/backups/fuku-pochi"
sudo mkdir -p "${BACKUP_DIR}"
sudo chown -R deploy:deploy "${BACKUP_DIR}"
sudo chmod 755 "${BACKUP_DIR}"

log_success "バックアップディレクトリ設定完了"

# ==============================================================================
# Docker権限の追加修正
# ==============================================================================

log_info "Docker権限追加修正中..."

# Dockerソケット権限（GitHub Actions対応）
sudo chmod 666 /var/run/docker.sock

log_success "Docker権限追加修正完了"
